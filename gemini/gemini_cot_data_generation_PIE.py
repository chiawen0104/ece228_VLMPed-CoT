...
# 3.  数据路径
# ════════════════════════════════════════════════════════════
ROOT = "./pedestrian_data_generation/data/pie"
paths = dict(
...
cot_save_dir = "./pedestrian_data_generation/data/pie/Cot_label/train"
...
# 保存 metrics
metrics_path = os.path.join(save_dir, "evaluation_results_PIE.txt")
...
# 保存 CSV 日志（包含推理输出）
csv_path = os.path.join(save_dir, "sample_logs_PIE.csv")
